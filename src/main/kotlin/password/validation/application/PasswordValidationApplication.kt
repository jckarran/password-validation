package password.validation.application

import password.validation.application.controller.UserController
import password.validation.application.metrics.StatisticsHandlerCollector
import password.validation.application.module.controllerModules
import password.validation.application.module.serviceModules
...
object PasswordValidationApplication : KoinComponent {

    private val logger = LogManager.getLogger(PasswordValidationApplication::class.java)
    ...
    fun init(): Javalin {
        ...
        val app = Javalin.create { config ->
            ...
            it.serverStopped(PasswordValidationApplication::stop)
        }.apply {
